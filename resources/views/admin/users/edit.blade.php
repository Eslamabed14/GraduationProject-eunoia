        ...
        <div class="card-body">
            ...
            <form action="{{route('admin.user.update', $user->id)}}" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="phone_no" value="{{$user->phone_no}}" type="number" class="form-control" name="phone_no"  required >
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="age" type="number" value="{{$user->age}}" class="form-control" name="age"  required >
                    </div>
                </div>
